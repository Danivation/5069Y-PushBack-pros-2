...
EXCLUDE_SRC_FROM_LIB= $(SRCDIR)/main.cpp $(SRCDIR)/auton.cpp $(SRCDIR)/driver.cpp $(SRCDIR)/colorsort.cpp $(SRCDIR)/robot-config.cpp $(SRCDIR)/extras.cpp $(ROOT)/static/*.txt
